...
<body>
<h1>
<span class="action-span"><a href="/admin/Back/MemberLevel/lst">会员级别列表</a></span>
<span class="action-span1"><a href="/admin/Back/index/main">商之翼 管理中心</a> </span><span id="search_id" class="action-span1"> - 修改会员级别 </span>
...
<table width="100%" >
  <tr>
    ...
    <td><input type="text" name="level_name" maxlength="60" value="<?php echo ($data["level_name"]); ?>" /><span class="require-field">*</span></td>
  </tr>
  <tr>
      <input type='hidden' value='<?php echo ($data["id"]); ?>' name='id'/>
    <td class="label">积分下限:</td>
    <td><input type="text" name="bottom_num" maxlength="60" value="<?php echo ($data["bottom_num"]); ?>" /><span class="require-field">*</span></td>
  </tr>
  <tr>
      <input type='hidden' value='<?php echo ($data["id"]); ?>' name='id'/>
    <td class="label">积分下限:</td>
    <td><input type="text" name="top_num" maxlength="60" value="<?php echo ($data["top_num"]); ?>" /><span class="require-field">*</span></td>
  </tr>
  <tr>
      <input type='hidden' value='<?php echo ($data["id"]); ?>' name='id'/>
    <td class="label">折扣率:</td>
    <td><input type="text" name="rate" maxlength="60" value="<?php echo ($data["rate"]); ?>" /><span class="require-field"></span></td>
  </tr>
  <!-- #代码增加2014-12-23 by www.68ecshop.com  _end -->
      <tr>
