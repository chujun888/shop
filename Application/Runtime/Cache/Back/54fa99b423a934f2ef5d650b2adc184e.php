...
<style type="text/css">
#header-div {
  background:url(/Public/images/top_bg.gif) repeat-x;
...
#admininfo-div span.left{float:left;height:68px; line-height:58px;background:url(/Public/images/ui_04.png) no-repeat 10px 12px; text-indent:30px; color:#d2d4d1;}
#admininfo-div span.right{float:left;height:68px; line-height:58px;background:url(/Public/images/ui_17.png) no-repeat 5px 13px; text-indent:20px; color:#e9e9e9;}
...
#submenu-div li {
float: right;
 width:77px;  text-align:center; height:68px; background:url(/Public/images/top_line.gif) no-repeat left top;
}
#submenu-div li a{
display:block; background:url(/Public/images/top_header.png) no-repeat left top; padding-top:30px; height:38px; line-height:38px;
}
...
background:url(/Public/images/top_header_hover.png) no-repeat; 
}
...
#menu-div li.midd_21 {
	background:url(/Public/images/midd.png) no-repeat;background-position:10px 13px; border-left:4px #0e94d1 solid; text-indent:12px;

}
#menu-div li.midd_22 {
		background:url(/Public/images/midd.png) no-repeat;background-position:0px -18px;

}
#menu-div li.midd_23 {
	background:url(/Public/images/midd.png) no-repeat;background-position:0px -54px;

}
#menu-div li.midd_1 {
	background:url(/Public/images/midd.png) no-repeat;background-position:0px -93px;
}
#menu-div li.midd_2 {
	background:url(/Public/images/midd.png) no-repeat;background-position:0px -133px;
}
#menu-div li.midd_3 {
	background:url(/Public/images/midd.png) no-repeat;background-position:0px -172px;
}
#menu-div li.midd_4 {
	background:url(/Public/images/midd.png) no-repeat;background-position:0px -208px;
}
#menu-div li.midd_5 {
	background:url(/Public/images/midd.png) no-repeat;background-position:0px -245px;
}
#menu-div li#xinjian_div {
	background:url(/Public/images/midd.png) no-repeat;background-position:0px -274px;
}

#menu-div li span{
background:url(/Public/images/numberico.png) no-repeat right bottom; display:inline-block; color:#FFF; font-size:12px; height:18px; padding:0px; text-align:center; line-height:18px; padding-right:8px; margin-left:5px;}
#menu-div li span em{
background:url(/Public/images/numberico.png) no-repeat left top; width:8px;display:inline-block;font-size:12px;  height:18px; vertical-align:top;}
...
<script type="text/javascript" src="..//Public/js/transport.org.js"></script><script type="text/javascript">
onload = function()
{
...
<div id="logo-div"><img src="/Public/images/ecshop_logo.png" alt="68ECSHOP" /></div>
...
<div id="submenu-div">
<ul>
<li class="show_9"><a href="/Back/Index/logout" target="_top">退出</a></li>
...
<li class="show_6"><a href="/Back/manage/edit/id/<?php echo session('id');?>" target="main_frame">个人设置</a></li>
...
<li class="show_1"><a href="../" target="_blank">查看网店</a></li>--></ul>
...
<!--<li id="xinjian_div">
<a href="javascript:void(0)" onmouseover="show_popup()" style="display:block;"> 新建 </a>
</li>
    
-->    <li class="midd_22"><a href="/Back/Index/main" target="main_frame">起始页</a></li>
<!--    <li class="midd_23"><a href="privilege.php?act=modif" target="main_frame">设置导航栏</a></li>-->
    <li class="midd_1"><a href="/Back/goods/lst" target="main_frame">商品列表<span><em></em>117</span></a></li>
