...
<body>
<h1>
<span class="action-span"><a href="/admin/Back/MemberLevel/add">添加新会员级别</a></span>
...
<script type="text/javascript" src="/admin/Public/js/jquery.ztree.all-3.5.min.js"></script><script type="text/javascript" src="/admin/Public/js/category_selecter.js"></script><div class="form-div">
    <form action="/admin/Back/MemberLevel/lst" name='search' method="post">
...
<?php foreach($data as $k=>$v):?>  <tr>
    <tr>
    <td><?php echo ($v["id"]); ?></td>
         	 <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 233)"><?php echo ($v["level_name"]); ?></span></td>
         	 <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 233)"><?php echo ($v["bottom_num"]); ?></span></td>
         	 <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 233)"><?php echo ($v["top_num"]); ?></span></td>
         	 <td class="first-cell" style=""><span onclick="listTable.edit(this, 'edit_goods_name', 233)"><?php echo ($v["rate"]); ?></span></td>
            
        
    <td align="center">
      
      <a href="/admin/Back/MemberLevel/edit/id/<?php echo ($v["id"]); ?>" title="编辑"><img src="/admin/Public/images/icon_edit.gif" width="16" height="16" border="0" /></a>  
...
function remove(e,id){
    if(confirm('确定要删除吗？')){
        ...
        //数据库删除
        $.ajax({
            url:"/admin/Back/MemberLevel/delete/id/"+id,
            type:'get',
            dataType:'json',
