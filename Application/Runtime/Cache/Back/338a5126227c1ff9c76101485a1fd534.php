...
<body>
<h1>
<span class="action-span"><a href="/Back/Type/add">添加新商品类型</a></span>
...
<script type="text/javascript" src="/Public/js/jquery.ztree.all-3.5.min.js"></script><script type="text/javascript" src="/Public/js/category_selecter.js"></script><div class="form-div">
    <form action="/Back/Type/lst" name='search' method="post">
...
<?php foreach($data as $k=>$v):?>  <tr>
    ...
    <td align="center">
        <span style="margin-bottom: 20px;"><u><a href="/Back/attr/lst/type_id/<?php echo ($v["id"]); ?>">属性列表</a></u></span>  
      <a href="/Back/Type/edit/id/<?php echo ($v["id"]); ?>" title="编辑"><img src="/Public/images/icon_edit.gif" width="16" height="16" border="0" /></a>  
