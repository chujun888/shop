...
<table width="100%" >
  <tr>
    ...
    <td><input type="text" name="attr_name" maxlength="60" value="<?php echo ($data["attr_name"]); ?>" /><span class="require-field">*</span></td>
  </tr>
  <tr>
      <input type='hidden' value='<?php echo ($data["id"]); ?>' name='id'/>
    <td class="label">商品类型:</td>
    <td>
        <select name='type_id'><?php foreach($types as $k=>$v):?><option value='<?php echo ($v["id"]); ?>' <?php if($data['type_id']==$v['id']) echo 'selected';?>><?php echo ($v["type_name"]); ?></option><?php endforeach;?></select>
    </td>
  </tr>
  <tr>
  <tr>
    ...
    <td><input type="text" name="attr_type" maxlength="60" value="<?php echo ($data["attr_type"]); ?>" /><span class="require-field"></span></td>
  </tr>
  <tr>
      
      <input type='hidden' value='<?php echo ($data["id"]); ?>' name='id'/>
    <td class="label">可选值：（多个用,分开）:</td>
    <td><input type="text" name="attr_option_value" maxlength="60" value="<?php echo ($data["attr_option_value"]); ?>" /><span class="require-field"></span></td>
  </tr>
  <!-- #代码增加2014-12-23 by www.68ecshop.com  _end -->
      <tr>
