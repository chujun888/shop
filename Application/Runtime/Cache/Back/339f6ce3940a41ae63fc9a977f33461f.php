...
<span class="action-span1"><a href="/Back/index/main">商之翼 管理中心</a> </span><span id="search_id" class="action-span1"> - 添加权限 </span>
...
<table width="100%" >
  ...
  <tr>
    ...
    <td><select name='parent_id'><option value='0' selected>顶级权限</option><?php foreach($data as $k=>$v):?><option value='<?php echo ($v["id"]); ?>'><?php echo str_repeat('&nbsp;',($v['level']+1)*5); echo ($v["pri_name"]); ?></option><?php endforeach;?></select><span class="require-field"></span></td>
  </tr>
  <tr>
