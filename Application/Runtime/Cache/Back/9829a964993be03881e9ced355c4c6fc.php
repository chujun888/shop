		...
		<form enctype="multipart/form-data" action="" method="post" name="theForm">
			...
			<table width="100%" id="general-table" align="center">
				...
				<tr id="promote_4">
					...
					<td id="promote_6">
                                            <input name="promote_start_time" type="text" id="promote_start_time" size="12"  value='' readonly='readonly' />
						
						-
						<input name="promote_end_time" type="text" id="promote_end_time" size="12" value='' readonly='readonly' />
