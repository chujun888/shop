...
<body>
<h1>
<span class="action-span"><a href="/Back/Brand/lst">商品品牌列表</a></span>
<span class="action-span1"><a href="/Back/index/main">商之翼 管理中心</a> </span><span id="search_id" class="action-span1"> - 修改商品品牌 </span>
...
<table width="100%" >
  ...
  <tr>
    ...
    <td><input type="text" name="url" maxlength="60" value="<?php echo ($data["url"]); ?>" /><span class="require-field">*</span></td>
  </tr>
<tr>
     <td class="label">上传品牌图片：</td>
      <td>
