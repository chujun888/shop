...
<script type="text/javascript" src="..//Public/js/utils.js"></script><script type="text/javascript" src="/Public/js/validator.js"></script><script language="JavaScript">
<!--
// 这里把JS用到的所有语言都赋值到这里
...
<body style="background:url(/Public/images/login_bg.png) repeat-x;padding:0px;">
<div style="width:1210px;height:768px;margin:0 auto;background:url(/Public/images/login_dl.jpg) no-repeat; " >
...
<td class="dl">
      ...
      <tr>
        ...
        <td><input type="text" name="admin_name" class="text_input1"/></td>
      </tr>
      <tr>
        <td class="dl_2">密　码</td>
        <td><input type="password" name="admin_pwd"  class="text_input1"/></td>
      </tr>
           <tr class="low_height">
        <td>&nbsp;</td>
