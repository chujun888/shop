...
<?php foreach($pris as $k=>$v):?>
 <tr>
  <td width="18%" valign="top" class="first-cell">
    <input name="pris[]" type="checkbox" value="<?php echo ($v["id"]); ?>" onclick="check(this)" class="checkbox"><?php echo ($v["pri_name"]); ?>  </td>
  <td>
 <?php foreach($v['children'] as $k1=>$v1):?>
        <div style="width:200px;float:left;">
    <label for="goods_manage"><input type="checkbox" name="pris[]" value="<?php echo ($v1["id"]); ?>" id="goods_manage" class="checkbox"  onclick="checkPrev(this)" title=""/>
