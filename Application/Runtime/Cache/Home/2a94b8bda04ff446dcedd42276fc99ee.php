	...
	<div class="floor1 floor w1210 bc mt10">
		...
		<div class="floor_left fl">
			...
			<div class="cate fl">
				...
				<div class="cate_wrap">
					<ul>
                                            <?php foreach($v['unrec_cat'] as $k1=>$v1):?>
			...
			<div class="goodslist fl">
				<h2>
					...
					<?php foreach($v['rec_cat'] as $k2=>$v2):?>
					<span><?php echo ($v2["cat_name"]); ?></span>
				...
				<div class="goodslist_wrap">
					...
					<?php foreach($v['rec_cat'] as $k5=>$v5):?>
					<div class="none">
						<ul>
		...
		<div class="sidebar fl ml10">
			...
			<div class="brand">
				...
				<div class="sidebar_wrap">
					<ul>
                                                <?php foreach($v['brand'] as $k2=>$v2):?>
						<li><a href=""><?php showImage($v2['logo']);?></a></li>
						<?php endforeach;?>
					</ul>
				</div>
			</div>
