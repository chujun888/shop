...
<h1>
<span class="action-span"><a href="/admin/Back/Goods/add">添加新商品</a></span>
...
<script type="text/javascript" src="/admin/Public/js/jquery.ztree.all-3.5.min.js"></script><script type="text/javascript" src="/admin/Public/js/category_selecter.js"></script><div class="form-div">
    <form action="/admin/Back/Goods/lst" name='search' method="post">
 ...
 <?php foreach($data as $k=>$v):?>
  <tr>
    ...
    <td align="right"><span onclick="listTable.edit(this, 'edit_goods_price', 233)"><?php echo ($v["shop_price"]); ?>
            ...
            <td align="center"><img src="/admin/Public/images/<?php if($v['is_on_sale']) echo 'yes';else echo 'no'; ?>.gif" onclick="listTable.toggle(this, 'toggle_on_sale', 233)" /></td>
    <td align="center"><img src="/admin/Public/images/<?php if($v['is_best']) echo 'yes';else echo 'no';?>.gif" onclick="listTable.toggle(this, 'toggle_best', 233)" /></td>
    <td align="center"><img src="/admin/Public/images/<?php if($v['is_new']) echo 'yes';else echo 'no';?>.gif" onclick="listTable.toggle(this, 'toggle_new', 233)" /></td>
    <td align="center"><img src="/admin/Public/images/<?php if($v['is_hot']) echo 'yes';else echo 'no'; ?>.gif" onclick="listTable.toggle(this, 'toggle_hot', 233)" /></td>
...
function remove(e,id){
    if(confirm('确定要将商品放入回收站吗？')){
        ...
        //数据库删除
        $.ajax({
            url:"/admin/Back/Goods/recycle/id/"+id,
            type:'get',
            dataType:'json',
