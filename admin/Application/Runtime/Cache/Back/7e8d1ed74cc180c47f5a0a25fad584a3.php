...
.article_menu LI.button_wu A {
	DISPLAY: block;
	FONT-SIZE: 14px;
	BACKGROUND: url(/admin/Public/images/menu_bottom.gif) no-repeat 0px 0px;
	OVERFLOW: hidden;
	WIDTH: 100%;
	TEXT-INDENT: 35px;
	LINE-HEIGHT: 35px;
...
.article_menu LI.button_wu A SPAN {
	RIGHT: 5px;
	BACKGROUND: url(/admin/Public/images/help_menu-b5.gif) no-repeat;
	WIDTH: 16px;
	float: right;
	TOP: 15px;
	HEIGHT: 16px
...
.article_menu LI.button A {
	BACKGROUND: url(/admin/Public/images/menu_bottom.gif) #e6e6e6 no-repeat center 44px;
	DISPLAY: block;
	FONT-SIZE: 14px;
	OVERFLOW: hidden;
	WIDTH: 100%;
...
.article_menu LI.button A em {
	background: url(/admin/Public/images/allico.png) no-repeat;
...
.article_menu LI.button A SPAN {
	RIGHT: 5px;
	BACKGROUND: url(/admin/Public/images/help_menu-plus.gif) no-repeat;
	WIDTH: 16px;
	POSITION: absolute;
	TOP: 20px;
	HEIGHT: 16px
...
#menu-ul-suo {
	BACKGROUND: url(/admin/Public/images/show_right.gif) no-repeat left top;
	width: 37px;
	height: 490px;
	display: none;
	float: left;
...
.dropdown LI {
	DISPLAY: block;
	PADDING-LEFT: 55px;
	BACKGROUND: url(/admin/Public/images/menu_arrow.gif) no-repeat 0px center;
	COLOR: #666;
	LINE-HEIGHT: 30px;
...
<script type="text/javascript" src="/js/jquery.min.js"></script><script type="text/javascript" src="/js/jquery.easing.1.3.js"></script><script type="text/javascript" src="/js/helpmenu.js"></script><script>
function showmenu()
{
  ...
  imgArrow = parent.drag_frame.document.getElementById('img');
    ...
    frmBody.cols="195, 12, *";
    imgArrow.src = "/admin/Public/images/arrow_left.gif";
...
<ul>
  ...
  <li  class="dropdown" id="02_cat_and_goods">
         <ul>
          ...
          <li><a href="/admin/Back/goods/add" target="main_frame">添加新商品</a></li>
          <li><a href="/admin/Back/goods/lst" target="main_frame">商品分类</a></li>
         
        </ul>
          <ul>

          <li><a href="/admin/Back/type/add" target="main_frame">添加类型</a></li>
          <li><a href="/admin/Back/type/lst" target="main_frame">类型分类</a></li>
  ...
  <li  class="dropdown" id="02_cat_and_goods">
         <ul>
          ...
          <li><a href="/admin/Back/attr/add" target="main_frame">添加商品属性</a></li>
          <li><a href="/admin/Back/attr/lst" target="main_frame">属性分类</a></li>
