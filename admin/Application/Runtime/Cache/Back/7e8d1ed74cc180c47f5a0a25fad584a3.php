...
<ul>
 <?php foreach($data as $k=>$v):?>
  ...
  <A  href="javascript:void(0);"><em  id="h1_02_cat_and_goods"></em><?php echo ($v["pri_name"]); ?><SPAN id="fa_02_cat_and_goods"></SPAN></A></li>
    <li  class="dropdown" id="02_cat_and_goods">
         <ul>
         <?php foreach($v['children'] as $k1=>$v2):?>
          <li><a href="/admin/index.php/<?php echo ($v2["module_name"]); ?>/<?php echo ($v2["controller_name"]); ?>/<?php echo ($v2["action_name"]); ?>" target="main_frame"><?php echo ($v2["pri_name"]); ?></a></li>
         <?php endforeach;?>
